...
import { ArrowLeft, ArrowRight, ExternalLink, RotateCw, X, Crosshair } from 'lucide-react'
...
import { InspectPromptBar } from './InspectPromptBar'
      ...
      <div className="flex items-center gap-1 border-b border-border bg-background px-2 py-1">
        ...
        {preview && terminalId && (
          <>
            <button
              type="button"
              aria-label="Inspect and annotate UI"
